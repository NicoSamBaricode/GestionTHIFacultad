...
$consulta= "SELECT nombre,apellido,rol,mail FROM usuarios";
?>
<!DOCTYPE html>
<html>
                                ...
                                <tbody>
                                        ...
                                        ?>
                                           <tr> 
                                            ...
                                            <td><a class="btn btn-info mx-auto btn-circle ml-1" role="button"><i class="fas fa-user-circle text-white"></i></a></td>
                                            <td><a class="btn btn-danger  mx-auto btn-circle ml-1" role="button"><i class="fas fa-trash text-white"></i></a></td>
                                           </tr>
