        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="Jefe_division.html"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
                    
                    <li class="nav-item" role="presentation"><a class="nav-link" href="Proyectos_jefe.html"><i class="fas fa-table"></i><span>Proyectos</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="Lista_Recursos_jefe.html"><i class="fas fa-warehouse"></i><span>Recursos</span></a></li>
                ...
                <div class="col-auto col-lg-6 mx-auto mb-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <h4 class="small font-weight-bold">Implementación Sistema de Gestión THI<span class="float-right">Completa!</span></h4>
                            <div class="progress mb-4">
